    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>Aplikasi Toko Online</strong> Aplikasi ini di buat oleh Agung Ra, yang merupakan mahasiswa Aktif Teknik Informatika!</p>
                <a class="btn btn-success btn-sm" href="https://startbootstrap.com/theme/sb-admin-pro">Klik Now!</a>
            </div>
